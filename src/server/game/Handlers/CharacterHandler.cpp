        ...
        case 3:
        {
            ...
            if (createInfo->Class == CLASS_HUNTER)
            {
                ...
                switch (createInfo->Race)
                {
                    case RACE_HUMAN:
                    {
                        std::string PetName="Wolf";
                        if (loc_idx >= 0)
                            if (CreatureFamilyLocale const* player = sObjectMgr->GetCreatureFamilyLocale(1))
                                ObjectMgr::GetLocaleString(player->Name, loc_idx, PetName);
                        CharacterDatabase.PExecute("REPLACE INTO character_pet (`id`, `entry`, `owner`, `modelid`, `CreatedBySpell`, `PetType`, `level`, `exp`, `Reactstate`, `name`, `renamed`, `slot`, `curhealth`, `curmana`, `savetime`, `abdata`, `specialization`) VALUES (%u, 299, %u, 903, 13481, 1, 1, 0, 0, '%s', 0, 0, 192, 0, 1295727347, '7 2 7 1 7 0 129 2649 129 17253 1 0 1 0 6 2 6 1 6 0 ', 0)", pet_id, newChar.GetGUIDLow(), PetName.c_str());
                    }
                        break;
                    case RACE_DWARF:
                    {
                        std::string PetName="Bear";
                        if (loc_idx >= 0)
                            if (CreatureFamilyLocale const* player = sObjectMgr->GetCreatureFamilyLocale(4))
                                ObjectMgr::GetLocaleString(player->Name, loc_idx, PetName);
                        CharacterDatabase.PExecute("REPLACE INTO character_pet (`id`, `entry`, `owner`, `modelid`, `CreatedBySpell`, `PetType`, `level`, `exp`, `Reactstate`, `name`, `renamed`, `slot`, `curhealth`, `curmana`, `savetime`, `abdata`, `specialization`) VALUES (%u, 42713, %u, 822, 13481, 1, 1, 0, 0, '%s', 0, 0, 212, 0, 1295727650, '7 2 7 1 7 0 129 2649 129 16827 1 0 1 0 6 2 6 1 6 0 ', 0)", pet_id, newChar.GetGUIDLow(), PetName.c_str());
                    }
                        break;
                    case RACE_ORC:
                    {
                        std::string PetName="Boar";
                        if (loc_idx >= 0)
                            if (CreatureFamilyLocale const* player = sObjectMgr->GetCreatureFamilyLocale(5))
                                ObjectMgr::GetLocaleString(player->Name, loc_idx, PetName);
                        CharacterDatabase.PExecute("REPLACE INTO character_pet (`id`, `entry`, `owner`, `modelid`, `CreatedBySpell`, `PetType`, `level`, `exp`, `Reactstate`, `name`, `renamed`, `slot`, `curhealth`, `curmana`, `savetime`, `abdata`, `specialization`) VALUES (%u, 42719, %u, 744, 13481, 1, 1, 0, 0, '%s', 0, 0, 212, 0, 1295727175, '7 2 7 1 7 0 129 2649 129 17253 1 0 1 0 6 2 6 1 6 0 ', 0)", pet_id, newChar.GetGUIDLow(), PetName.c_str());
                    }
                        break;
                    case RACE_NIGHTELF:
                    {
                        ...
                        if (loc_idx >= 0)
                            if (CreatureFamilyLocale const* player = sObjectMgr->GetCreatureFamilyLocale(2))
                                ObjectMgr::GetLocaleString(player->Name, loc_idx, PetName);
                        CharacterDatabase.PExecute("REPLACE INTO character_pet (`id`, `entry`, `owner`, `modelid`, `CreatedBySpell`, `PetType`, `level`, `exp`, `Reactstate`, `name`, `renamed`, `slot`, `curhealth`, `curmana`, `savetime`, `abdata`, `specialization`) VALUES (%u, 42718, %u,  17090, 13481, 1, 1, 0, 0, '%s', 0, 0, 192, 0, 1295727501, '7 2 7 1 7 0 129 2649 129 16827 1 0 1 0 6 2 6 1 6 0 ', 0)", pet_id, newChar.GetGUIDLow(), PetName.c_str());
                    }
                        break;
                    case RACE_UNDEAD_PLAYER:
                    {
                        std::string PetName="Spider";
                        if (loc_idx >= 0)
                            if (CreatureFamilyLocale const* player = sObjectMgr->GetCreatureFamilyLocale(3))
                                ObjectMgr::GetLocaleString(player->Name, loc_idx, PetName);
                        CharacterDatabase.PExecute("REPLACE INTO character_pet (`id`, `entry`, `owner`, `modelid`, `CreatedBySpell`, `PetType`, `level`, `exp`, `Reactstate`, `name`, `renamed`, `slot`, `curhealth`, `curmana`, `savetime`, `abdata`, `specialization`) VALUES (%u, 51107, %u,  368, 13481, 1, 1, 0, 0, '%s', 0, 0, 202, 0, 1295727821, '7 2 7 1 7 0 129 2649 129 17253 1 0 1 0 6 2 6 1 6 0 ', 0)", pet_id, newChar.GetGUIDLow(), PetName.c_str());
                    }
                        break;
                    case RACE_TAUREN:
                    {
                        std::string PetName="Tallstrider";
                        if (loc_idx >= 0)
                            if (CreatureFamilyLocale const* player = sObjectMgr->GetCreatureFamilyLocale(12))
                                ObjectMgr::GetLocaleString(player->Name, loc_idx, PetName);
                        CharacterDatabase.PExecute("REPLACE INTO character_pet (`id`, `entry`, `owner`, `modelid`, `CreatedBySpell`, `PetType`, `level`, `exp`, `Reactstate`, `name`, `renamed`, `slot`, `curhealth`, `curmana`, `savetime`, `abdata`, `specialization`) VALUES (%u, 42720, %u,  29057, 13481, 1, 1, 0, 0, '%s', 0, 0, 192, 0, 1295727912, '7 2 7 1 7 0 129 2649 129 16827 1 0 1 0 6 2 6 1 6 0 ', 0)", pet_id, newChar.GetGUIDLow(), PetName.c_str());
                    }
                        break;
                    case RACE_TROLL:
                    {
                        std::string PetName="Raptor";
                        if (loc_idx >= 0)
                            if (CreatureFamilyLocale const* player = sObjectMgr->GetCreatureFamilyLocale(11))
                                ObjectMgr::GetLocaleString(player->Name, loc_idx, PetName);
                        CharacterDatabase.PExecute("REPLACE INTO character_pet (`id`, `entry`, `owner`, `modelid`, `CreatedBySpell`, `PetType`, `level`, `exp`, `Reactstate`, `name`, `renamed`, `slot`, `curhealth`, `curmana`, `savetime`, `abdata`, `specialization`) VALUES (%u, 42721, %u,  23518, 13481, 1, 1, 0, 0, '%s', 0, 0, 192, 0, 1295727987, '7 2 7 1 7 0 129 2649 129 50498 129 16827 1 0 6 2 6 1 6 0 ', 0)", pet_id, newChar.GetGUIDLow(), PetName.c_str());
                    }
                        break;
                    case RACE_GOBLIN:
                    {
                        std::string PetName="Crab";
                        if (loc_idx >= 0)
                            if (CreatureFamilyLocale const* player = sObjectMgr->GetCreatureFamilyLocale(8))
                                ObjectMgr::GetLocaleString(player->Name, loc_idx, PetName);
                        CharacterDatabase.PExecute("REPLACE INTO character_pet (`id`, `entry`, `owner`, `modelid`, `CreatedBySpell`, `PetType`, `level`, `exp`, `Reactstate`, `name`, `renamed`, `slot`, `curhealth`, `curmana`, `savetime`, `abdata`, `specialization`) VALUES (%u, 42715, %u, 27692, 13481, 1, 1, 0, 0, '%s', 0, 0, 212, 0, 1295720595, '7 2 7 1 7 0 129 2649 129 16827 1 0 1 0 6 2 6 1 6 0 ', 0)", pet_id, newChar.GetGUIDLow(), PetName.c_str());
                    }
                        break;
                    case RACE_BLOODELF:
                    {
                        std::string PetName="Dragonhawk";
                        if (loc_idx >= 0)
                            if (CreatureFamilyLocale const* player = sObjectMgr->GetCreatureFamilyLocale(30))
                                ObjectMgr::GetLocaleString(player->Name, loc_idx, PetName);
                        CharacterDatabase.PExecute("REPLACE INTO character_pet (`id`, `entry`, `owner`, `modelid`, `CreatedBySpell`, `PetType`, `level`, `exp`, `Reactstate`, `name`, `renamed`, `slot`, `curhealth`, `curmana`, `savetime`, `abdata`, `specialization`) VALUES (%u, 42710, %u, 23515, 13481, 1, 1, 0, 0, '%s', 0, 0, 202, 0, 1295728068, '7 2 7 1 7 0 129 2649 129 17253 1 0 1 0 6 2 6 1 6 0 ', 0)", pet_id, newChar.GetGUIDLow(), PetName.c_str());
                    }
                        break;
                    case RACE_DRAENEI:
                    {
                        std::string PetName="Moth";
                        if (loc_idx >= 0)
                            if (CreatureFamilyLocale const* player = sObjectMgr->GetCreatureFamilyLocale(37))
                                ObjectMgr::GetLocaleString(player->Name, loc_idx, PetName);
                        CharacterDatabase.PExecute("REPLACE INTO character_pet (`id`, `entry`, `owner`, `modelid`, `CreatedBySpell`, `PetType`, `level`, `exp`, `Reactstate`, `name`, `renamed`, `slot`, `curhealth`, `curmana`, `savetime`, `abdata`, `specialization`) VALUES (%u, 42712, %u, 29056, 13481, 1, 1, 0, 0, '%s', 0, 0, 192, 0, 1295728128, '7 2 7 1 7 0 129 2649 129 49966 1 0 1 0 6 2 6 1 6 0 ', 0)", pet_id, newChar.GetGUIDLow(), PetName.c_str());
                    }
                        break;
                    case RACE_WORGEN:
                    {
                        std::string PetName="Dog";
                        if (loc_idx >= 0)
                            if (CreatureFamilyLocale const* player = sObjectMgr->GetCreatureFamilyLocale(52))
                                ObjectMgr::GetLocaleString(player->Name, loc_idx, PetName);
                        CharacterDatabase.PExecute("REPLACE INTO character_pet (`id`, `entry`, `owner`, `modelid`, `CreatedBySpell`, `PetType`, `level`, `exp`, `Reactstate`, `name`, `renamed`, `slot`, `curhealth`, `curmana`, `savetime`, `abdata`, `specialization`) VALUES (%u, 42722, %u, 30221, 13481, 1, 1, 0, 0, '%s', 0, 0, 192, 0, 1295728219, '7 2 7 1 7 0 129 2649 129 17253 1 0 1 0 6 2 6 1 6 0 ', 0)", pet_id, newChar.GetGUIDLow(), PetName.c_str());
                    }
                        break;
                    case RACE_PANDAREN_NEUTRAL:
                    {
                        std::string PetName="Turtle";
                        if (loc_idx >= 0)
                            if (CreatureFamilyLocale const* player = sObjectMgr->GetCreatureFamilyLocale(21))
                                ObjectMgr::GetLocaleString(player->Name, loc_idx, PetName);
                        CharacterDatabase.PExecute("REPLACE INTO character_pet (`id`, `entry`, `owner`, `modelid`, `CreatedBySpell`, `PetType`, `level`, `exp`, `Reactstate`, `name`, `renamed`, `slot`, `curhealth`, `curmana`, `savetime`, `abdata`, `specialization`) VALUES (%u, 57239, %u, 42656, 13481, 1, 1, 0, 0, '%s', 0, 0, 192, 0, 1295728219, '7 2 7 1 7 0 129 2649 129 17253 1 0 1 0 6 2 6 1 6 0 ', 0)", pet_id, newChar.GetGUIDLow(), PetName.c_str());
                    }
                        break;
                    default:
                        break;
